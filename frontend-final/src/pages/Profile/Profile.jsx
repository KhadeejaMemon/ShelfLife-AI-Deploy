...
function Profile() {
  ...
  function notifyProfileUpdated() {
    window.dispatchEvent(
      new Event("shelflife-profile-updated")
    );
  }
    ...
    <>
      ...
      <section className="mt-8 grid gap-7 xl:grid-cols-[0.85fr_1.5fr]">
        ...
        <article className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-gray-500">
            Change the username displayed on your dashboard.
          </p>
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full bg-transparent py-4 outline-none disabled:text-gray-500"
              />
            ...
            {!isEditingName ? (
              ...
              <button
                ...
                className="mt-5 flex items-center gap-2 rounded-xl border border-green-700 px-6 py-3 font-semibold text-green-700 hover:bg-green-50"
              >
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl border border-gray-300 px-6 py-3 font-semibold text-gray-700 hover:bg-gray-50"
                >
            ...
            <div className="flex items-start justify-between border-b border-gray-100 p-6">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Adjust your image before saving.
                </p>
            ...
            <div className="relative h-[420px] bg-gray-900">
              ...
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl bg-green-700 px-6 py-3 font-semibold text-white hover:bg-green-800 disabled:opacity-50"
